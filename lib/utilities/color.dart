...
extension colors on ColorScheme {
  ...
  //new
  static const Color primary = Color(0xFFF7DB16);
  static const Color secondary = Color(0xC7168CC1);
  static const Color buttonColor = Color(0xFF168CC1);
  ...
  static const Color lightButton = Color(0xff168CC1);
  ...
  static const Color homeBGGradient1 = Color(0xFF168CC1);
  static const Color homeBGGradient2 = Color(0xFF168CC1);
  ...
  static const Color theme = Color(0xff168CC1);
  ...
  static const Color grad1Color = Color(0xffF7DB16);
  static const Color grad2Color = Color(0xC7168CC1);
